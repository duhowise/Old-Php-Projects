        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 ...
				 $query="select COUNT(*) as '0' from offering where na='$session_id'";
				 ...
				 $count=$result->fetch_assoc();
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								Number of Givings: <span class="badge badge-info"><?php  echo $count[0]  ; ?></span>
							 </div>
                            </div>
								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													require_once('..\dbconnect.php');
													$query="select * from members INNER JOIN offering ON members.id=offering.na where na='$session_id'";
													$result=$mysqli->query($query);
