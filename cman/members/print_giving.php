...
<table class=msoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:23.25pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date<o:p></o:p></span></b></p>
   ...
   <!-- mYSQL FETCH ARRAY-->
<?php
		$student_query = $mysqli->query("select * from members INNER JOIN giving ON members.mobile=giving.na where giving.na='$session_id' ") ;
...
<table class=msoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <?php $query= $mysqli->query("select * from members where id = '$session_id'") ;
