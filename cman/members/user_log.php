            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                        <!-- block -->
						<?php	
	                 $count_log=$mysqli->query("select * from user_log");
                     ...
                     ?>
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								Number of System User Log: <span class="badge badge-info"><?php  echo $count[0]; ?></span>
								</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_user_log.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = $mysqli->query("select * from user_log order by login_date AND logout_date DESC") ;
