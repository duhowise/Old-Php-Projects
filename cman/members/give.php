    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 $query="select count(*) as '0'  from giving where na='$session_id'";
...
<!-----------------------------------Content------------------------------------>
<?php
		$query ="SELECT *FROm members  LEFT OUTER JOIN giving ON members.id = giving.na WHERE giving.na ='$session_id' ";
