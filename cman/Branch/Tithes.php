    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=$mysqli->query("select * from tithe");
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = $mysqli->query("SELECT *FROm members  LEFT OUTER JOIN tithe ON members.id = tithe.na WHERE tithe.titheid !='' ") ;
