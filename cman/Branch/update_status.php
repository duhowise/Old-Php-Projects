						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = $mysqli->query("select * from stdevice 
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									    ...
									    <div class="control-group">
											...
											<div class="controls">			
												<select id="qtype" name="dev_id" readonly="readonly" required>
													...
													<?php
													$device_query = $mysqli->query("select * from device_name") ;
													while($query_device_row =   ->fetch_assoc()($device_query)){
										...
										$mysqli->query("update stdevice set 
										            dev_id = '$dev_id',																		
													dev_status = '$dev_status'
													where id = '$get_id' ") ;
													
										$mysqli->query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Update Status $dev_name to $dev_status')") ;			
										?>
										<script>
