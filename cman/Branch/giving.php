    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=$mysqli->query("select * from giving");
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = $mysqli->query("SELECT *FROm members  LEFT OUTER JOIN giving ON members.id = giving.na WHERE giving.givingid !='' ") ;
