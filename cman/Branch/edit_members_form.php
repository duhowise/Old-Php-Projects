	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = $mysqli->query("select * from members where id = '$get_member_id'") ;
...
$mysqli->query("UPDATE members SET fname = '$fname',sname ='$sname',lname='$lname',Gender='$Gender',Birthday='$birthday', Residence='$residence',pob='$pob',ministry='$ministry',mobile='$mobile',email='$email',password='$password' where id='$get_member_id'") 
 ;

$mysqli->query ("insert into activity_log (date,username,action)
