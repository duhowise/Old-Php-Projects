    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=$mysqli->query("select * from offering");
	             $count =  ->fetch_assoc()count_student);
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Offering list</div>
                          <div class="muted pull-right">
								Number of payments: <span class="badge badge-info"><?php  echo $count[0]; ?></span>
							 </div>
						  </div>
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = $mysqli->query("SELECT *FROm members  LEFT OUTER JOIN offering ON members.id = offering.na WHERE offering.offeringid !='' ") ;
		while($row =   ->fetch_assoc()($student_query)){
