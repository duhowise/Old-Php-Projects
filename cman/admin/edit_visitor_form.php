	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = $mysqli->query("select * from visitor where id = '$get_visitor_id'") ;
...
$mysqli->query("UPDATE visitor SET fname = '$fname',sname ='$sname',lname='$lname',Gender='$Gender',Birthday='$birthday', Residence='$residence',pob='$pob',ministry='$ministry',mobile='$mobile'  where id='$get_visitor_id'") 
 ;
