...
$query = $mysqli->query("select count(*) as '0' from admin where username = '$username' and password = '$password' and firstname = '$firstname' and password = '$password' ");
...
$mysqli->query("insert into admin (username,password,firstname,lastname,adminthumbnails) values('$username','$password','$firstname','$lastname','images/NO-ImAGE-AVAILABLE.jpg')") ;

$mysqli->query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add System User $firstname')") ;
?>
<script>
