    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_log=$mysqli->query("select count(*) as '0' from members");
                 ...
                 ?>
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								Number of members: <span class="badge badge-info"><?php  echo $count[0]; ?></span>
								</div>
                            </div>
							<div class="container-fluid">
  <div class="row-fluid"> 
...
<!-----------------------------------Content------------------------------------>
<?php
		$members_query = $mysqli->query("select * from members") ;
