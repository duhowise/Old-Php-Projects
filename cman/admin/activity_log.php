    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_log=$mysqli->query("select count(*) as '0' from activity_log");
	             $count = $count_log->fetch_assoc();
                 ?>
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i> System User Activity Log</div>
								<div class="muted pull-right">
								Number of System user Activity Log: <span class="badge badge-info"><?php  echo $count[0]; ?></span>
								</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_log.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
                              		...
                              		<?php
										$query = $mysqli->query("select * from  activity_log order by date DESC");
