    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_members=$mysqli->query("select count(*) as '0' from visitor");
				   ...
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                          ...
                          <div class="muted pull-right">
								Number of Registered Visitors: <span class="badge badge-info"><?php  echo $count[0]; ?></span>
							 </div>
						  </div>
...
<!-----------------------------------Content------------------------------------>
<?php
		$members_query = $mysqli->query("select * from visitor") ;
