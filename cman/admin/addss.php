...
$query = @$mysqli->query("select count(*) as '0' from sundays where  mobile = '$mobile'  ") ;
...
$mysqli->query("insert into sundays(fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,thumbnail) 
