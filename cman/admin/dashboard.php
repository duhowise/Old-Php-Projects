            ...
            <div class="row-fluid">
			 <?php include('sidebar.php'); ?>		
                <div class="span9" id="content">
                    <div class="row-fluid">
         	         <?php $query= $mysqli->query("select * from admin where admin_id = '$session_id'");
...
<div id="page-wrapper">
        <?php 
	     $student = $mysqli->query("select count(*) as '0' from members ") ;
							  ...
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        <div class="huge"><?php echo $student[0]; ?></div>
...
<div id="page-wrapper">
        <?php 
	     $student = $mysqli->query("select count(*) as '0' from giving ");
		 $student =$student->fetch_assoc();
		 ?>
                <div class="row-fluid">				
                    <div class="span6">
...
$bd= $mysqli->query ("SELECT count(*) as '0'
FROm  members
                            ...
                            <div class="panel-heading">
							  <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8 text-right"><br/>
                                        <div class="huge"><?php echo $bd[0];?></div>
...
<div id="page-wrapper">
        <?php 
	    $result2 = $mysqli->query('SELECT SUm(Amount) AS value_sum FROm giving'); 
...
$sum2 = $row['value_sum'];
		...
		<?php 
		$result = $mysqli->query('SELECT SUm(Amount) AS value_sum FROm offering'); 
