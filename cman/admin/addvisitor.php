...
$query = @$mysqli->query("select count(*) as '0' from visitor where  mobile = '$mobile'  ") ;
...
$mysqli->query("insert into Visitor(fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,thumbnail) 
