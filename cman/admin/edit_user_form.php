	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = $mysqli->query("selectcount(*) as '0' from admin where admin_id = '$get_id'") ;
...
$mysqli->query("update admin set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where admin_id = '$get_id' ") ;
$mysqli->query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit system User $firstname')") ;	
?>
<script>
