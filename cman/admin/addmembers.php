...
$query = @$mysqli->query("select count(*) as '0' from members where  mobile = '$mobile'  ") ;
...
$mysqli->query("insert into members (fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,email,thumbnail,password) 
