...
$query = @$mysqli->query("select * from teens where  mobile = '$mobile'  ") ;
...
$mysqli->query("insert into teens (fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,thumbnail) 
